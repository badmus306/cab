...
<nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top" id="topNavBar">
              ...
              Cab Management
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'cab_available'? "active" : '' ?>" href="./?p=cab_available">Our Cab</a></li>
